...
Репозиторид олон төрлийн жишээ файлууд байна. `examples/` хавтас доторхи скриптүүдийг судалж, өөрийн төсөлд тохируулан ашиглана уу.

- Жишээ файл: `examples/quickstart.py`
- Репозиторийн холбоос: `https://github.com/yourusername/qpay-client`

Дараагийн алхам
--------------

Хэрвээ та хүсвэл би `quickstart.rst` дээр дээрхээс гадна:
- `quickstart` хуудасны дотор **CLI ашиглах өөрчлөлт/CLI жишээ** нэмэх,
- `quickstart`-ийн `index`-д заавал байрлах конфигурацийн (`.env` жишээ), лог тохиргооны код жишээг бэлтгэх,
- эсвэл дээрх жишээг `.md` (MyST) форматаар хөрвүүлэх — аль нэгийг бэлдэж өгөх болно.
